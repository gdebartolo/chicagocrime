...
var attNames = ["pc_pov", "pc_nohs", "pc_unemp", "vcrimes_pt", "pc_vacab", "lib_ptt"];
...
function setMap(){
  ...
  var map = new L.map('map').setView([41.8, -87.75], 10)
...
d3.json("data/chicago.json", function(error, jsonData) {
