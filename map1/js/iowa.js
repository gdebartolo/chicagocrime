...
var initialColors = colorbrewer.Greens[8];
...
var attNames = ["crops_norm", "manu_norm", "forest_nor", "pm_norm", "sm_norm", "urb_norm", "totalnorm"];
...
d3.json("data/biomass2.json", function(error, jsonData) {
  ...
  function createDropdown(jsonData){
    ...
    .append("div")
    .html("<h4>Select Biomass Type: </h4>")
    .append("select")
